...
Settings are stored through the browser’s sync-storage feature. Run history and captured reports are stored locally in extension-scoped IndexedDB and are deleted when evicted from the 20-run history or when the extension is removed.
